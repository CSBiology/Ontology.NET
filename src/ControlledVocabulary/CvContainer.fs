...
// TO DO: Delete this as soon as the functionality is part of an FSharpAux NuGet release
...
/// Represents a collection of structured properties, annotated with a CvTerm.
type CvContainer (
    cvAccession : string, 
    cvName     : string, 
    cvRef       : string, 
    ...
    /// Returns Some CvContainer if the given ICvBase item can be downcast, else returns None.
    ...
    /// Retrieves IParam children with the given name of the CvContainer as sequence.
    ///
    /// Fails if the propertyName cannot be found.
    ...
    /// Retrieves IParam child with the given name of the CvContainer.
    ///
    /// Returns None if there is not exactly one child with the given name or if the propertyName cannot be found.
    ...
    /// Returns true of the CvContainer contains a property under the given name.
    ...
    /// Returns the number of properties of the CvContainer.
    ...
    /// Returns the number of children of all properties of the CvContainer.
